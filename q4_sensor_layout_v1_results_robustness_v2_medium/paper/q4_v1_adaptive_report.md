...
- response phase jitter: `0.2`
- noise correlation: `0.3`
- prescreen count: `40`
- greedy+swap 到完整枚举最优的相对差距: `0.033438`
- 最优 V1 布局: `v1_p105+v1_p074+v1_p098`
- 最优 V1 区域: `gearbox_zone_right+gearbox_zone_left+gearbox_zone_left`
- 最优目标值: `9.1904e-05`
- Monte Carlo 验证最优布局: `v1_p105+v1_p074+v1_p062`
- Monte Carlo 验证最优区域: `gearbox_zone_right+gearbox_zone_left+gearbox_zone_left`
- Monte Carlo 验证分数: `0.522010`
