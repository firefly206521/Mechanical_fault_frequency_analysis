...
Validation weights: pd `0.45`, low_snr `0.35`, min_pd `0.2`, fa_excess `-2.0`
Robustness scenario: response_gain_jitter `0.1`, response_phase_jitter `0.1`, response_jitter_mode `sensor`, noise_correlation `0.2`
