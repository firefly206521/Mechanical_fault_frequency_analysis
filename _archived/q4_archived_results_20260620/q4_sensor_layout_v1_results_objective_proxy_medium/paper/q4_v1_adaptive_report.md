...
当前目标函数权重为：`detection_mean_lambda=0.4`，`trace_info=0.002`，`min_eigen=0.002`，`scaled_redundancy=-0.03`。其中冗余惩罚按融合检测强度缩放，不再使用绝对无量纲惩罚。
...
- grid size: `120`
- prescreen count: `40`
- greedy+swap 到完整枚举最优的相对差距: `0.087306`
- 最优 V1 布局: `v1_p075+v1_p074+v1_p086`
