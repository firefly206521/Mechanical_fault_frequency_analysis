...
```powershell
python -m q3_multisource_separation.run_q3 --simulation-runs 200 --resolution-runs 200 --null-runs 500
```

也可以进入本目录执行：

```powershell
python run_q3.py --simulation-runs 200 --resolution-runs 200 --null-runs 500
```

追加到500次时使用：

```powershell
python run_q3.py --simulation-runs 500 --resolution-runs 500 --resume
```
